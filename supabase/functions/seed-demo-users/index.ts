...
const demoUsers: DemoUser[] = [
  ...
  { email: "kurir1@demo.com", password: "demo123456", role: "courier", full_name: "Kurir Satu", phone: "081234567891" },
  { email: "kurir2@demo.com", password: "demo123456", role: "courier", full_name: "Kurir Dua", phone: "081234567892" },
  { email: "buyer1@demo.com", password: "demo123456", role: "buyer", full_name: "Pembeli Satu", phone: "081234567893", nik: "3201010101010001" },
  { email: "buyer2@demo.com", password: "demo123456", role: "buyer", full_name: "Pembeli Dua", phone: "081234567894", nik: "3201010101010002" },
  { email: "buyer3@demo.com", password: "demo123456", role: "buyer", full_name: "Pembeli Tiga", phone: "081234567895", nik: "3201010101010003" },
];
        ...
        if (user.role === "super_admin" || user.role === "admin_gudang" || user.role === "admin_keuangan") {
          ...
          if (!existingProfile) {
            await supabaseAdmin.from("courier_profiles").insert({
              ...
              vehicle_type: "Motor",
              vehicle_plate: "B " + Math.floor(1000 + Math.random() * 9000) + " ABC",
            });
          }
